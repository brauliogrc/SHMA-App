 ...
 * @author bruno
 */
public class TravelView extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        this.primaryStage.setTitle( "Viajes" );
    ...
    private void initLayout() {
        try {
            Parent root = FXMLLoader.load( getClass().getResource( "TravelView.fxml" ) );
