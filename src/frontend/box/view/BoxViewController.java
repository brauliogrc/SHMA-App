...
public class BoxViewController implements Initializable {
    ...
    public void cargar() {
        ...
        List<Box> obj = this.objDAO.getAll();
        ObservableList<Box> data = FXCollections.observableArrayList(obj);
        TableColumn idCol = new TableColumn("ID");
        idCol.setCellValueFactory(new PropertyValueFactory("idCaja"));
    ...
    public void initialize(URL url, ResourceBundle rb) {
        this.objDAO = new BoxDAO();
        cargar();
        labelTitulo.setText("Cajas");
